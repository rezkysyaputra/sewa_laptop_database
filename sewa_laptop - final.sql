...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Jul 2024 pada 18.34
...
(1, 'Dell', 'XPS 13', 'ABC123456', 100000.00, 20),
...
(6, 'Acer', 'Swift 3', 'XYZ123456', 95000.00, 10);
...
(2, 1, 'UPDATE', 'Stok: 15', 'Stok: 12', '2024-07-22 19:41:14'),
(3, 6, 'INSERT', NULL, 'Merek: Acer, Model: Swift 3, Nomor Seri: XYZ123456, Harga Sewa per Hari: 95000.00, Stok: 10', '2024-07-22 19:49:08'),
(4, 4, 'DELETE', 'Merek: Asus, Model: ZenBook 14, Nomor Seri: JKL901234, Harga Sewa per Hari: 110000.00, Stok: 7', NULL, '2024-07-22 19:51:19'),
(5, 1, 'UPDATE', 'Stok: 12', 'Stok: 20', '2024-07-22 23:20:04');
...
--
-- Dumping data untuk tabel `logpelanggan`
--

INSERT INTO `logpelanggan` (`log_id`, `pelanggan_id`, `action`, `old_value`, `new_value`, `change_date`) VALUES
(1, 0, 'INSERT', NULL, 'Nama: Pelanggan6, Alamat: Alamat6, Jenis Kelamin: L', '2024-07-22 19:43:03'),
(2, 5, 'UPDATE', 'Nama: Pelanggan5, Alamat: Alamat5, Jenis Kelamin: L', 'Nama: Pelanggan5 Baru, Alamat: Alamat5 Baru, Jenis Kelamin: P', '2024-07-22 19:50:21');
...
--
-- Dumping data untuk tabel `logsewa`
--

INSERT INTO `logsewa` (`log_id`, `sewa_id`, `action`, `old_value`, `new_value`, `change_date`) VALUES
(1, 5, 'DELETE', 'Pelanggan ID: 5, Admin ID: 5, Tanggal Sewa: 2024-07-05, Tanggal Kembali: 2024-07-15, Total Biaya: 900000.00, Status: Dibatalkan', NULL, '2024-07-22 19:47:49');
...
(5, 'Pelanggan5 Baru', 'Alamat5 Baru', 'P'),
(6, 'Pelanggan6', 'Alamat6', 'L');
...
(3, 3, 3, '2024-07-03', '2024-07-13', 850000.00, 'Berlangsung'),
(4, 4, 4, '2024-07-04', '2024-07-14', 800000.00, 'Berlangsung'),
(6, 3, 2, '2024-07-19', '2024-07-23', 900000.00, 'Berlangsung');
...
--
ALTER TABLE `pengembalian`
  MODIFY `pengembalian_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `sewa`
--
ALTER TABLE `sewa`
  MODIFY `sewa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
